...
LUALIB_API int luaopen_tmt(lua_State *L) {
	...
	LUA_T_PUSH_S_S("KEY_LEFT", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_HOME", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_END", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_INSERT", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_BACKSPACE", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_ESCAPE", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_BACK_TAB", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_PAGE_UP", TMT_KEY_UP)
	LUA_T_PUSH_S_S("KEY_PAGE_DOWN", TMT_KEY_UP)
	lua_settable(L, -3);
